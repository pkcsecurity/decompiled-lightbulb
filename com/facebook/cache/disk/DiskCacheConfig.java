...
public class DiskCacheConfig {
   ...
   private DiskCacheConfig(DiskCacheConfig.Builder var1) {
      ...
      if(var1.mCacheEventListener == null) {
         var2 = NoOpCacheEventListener.getInstance();
      } else {
         var2 = var1.mCacheEventListener;
      }

      this.mCacheEventListener = (CacheEventListener)var2;
      if(var1.mDiskTrimmableRegistry == null) {
         var2 = NoOpDiskTrimmableRegistry.getInstance();
      } else {
         var2 = var1.mDiskTrimmableRegistry;
      }

      this.mDiskTrimmableRegistry = (DiskTrimmableRegistry)var2;
      this.mContext = var1.mContext;
      this.mIndexPopulateAtStartupEnabled = var1.mIndexPopulateAtStartupEnabled;
   }
   ...
   public static DiskCacheConfig.Builder newBuilder(@Nullable Context var0) {
      return new DiskCacheConfig.Builder(var0, null);
   }
   ...
   public static class Builder {
      ...
      public DiskCacheConfig.Builder setBaseDirectoryPath(File var1) {
         this.mBaseDirectoryPathSupplier = Suppliers.of(var1);
         return this;
      }
      ...
      public DiskCacheConfig.Builder setIndexPopulateAtStartupEnabled(boolean var1) {
         this.mIndexPopulateAtStartupEnabled = var1;
         return this;
      }
