...
final class HorizontalDrawCommandManager extends ClippingDrawCommandManager {
   ...
   HorizontalDrawCommandManager(FlatViewGroup var1, DrawCommand[] var2) {
      super(var1, var2);
   }
   ...
   public static void fillMaxMinArrays(DrawCommand[] var0, float[] var1, float[] var2, SparseIntArray var3) {
      ...
      for(var5 = 0; var5 < var0.length; ++var5) {
         if(var0[var5] instanceof DrawView) {
            ...
            var4 = Math.max(var4, var6.mLogicalRight);
         } else {
            var4 = Math.max(var4, var0[var5].getRight());
         }
      ...
      for(var5 = var0.length - 1; var5 >= 0; --var5) {
         if(var0[var5] instanceof DrawView) {
            var4 = Math.min(var4, ((DrawView)var0[var5]).mLogicalLeft);
         } else {
            var4 = Math.min(var4, var0[var5].getLeft());
         }
   ...
   public static void fillMaxMinArrays(NodeRegion[] var0, float[] var1, float[] var2) {
      ...
      for(var4 = 0; var4 < var0.length; ++var4) {
         var3 = Math.max(var3, var0[var4].getTouchableRight());
         var1[var4] = var3;
      }

      for(var4 = var0.length - 1; var4 >= 0; --var4) {
         var3 = Math.min(var3, var0[var4].getTouchableLeft());
         var2[var4] = var3;
      }
   ...
   int commandStartIndex() {
      int var2 = Arrays.binarySearch(this.mCommandMaxBottom, (float)this.mClippingRect.left);
      int var1 = var2;
      if(var2 < 0) {
         var1 = ~var2;
      }
   ...
   int commandStopIndex(int var1) {
      int var2 = Arrays.binarySearch(this.mCommandMinTop, var1, this.mCommandMinTop.length, (float)this.mClippingRect.right);
      var1 = var2;
      if(var2 < 0) {
         var1 = ~var2;
      }
   ...
   boolean regionAboveTouch(int var1, float var2, float var3) {
      return this.mRegionMaxBottom[var1] < var2;
   }

   int regionStopIndex(float var1, float var2) {
      int var4 = Arrays.binarySearch(this.mRegionMinTop, var1 + 1.0E-4F);
      int var3 = var4;
      if(var4 < 0) {
         var3 = ~var4;
      }
