...
public class DefaultComparableDrawable extends ComparableDrawable implements Callback {

   private Drawable mDrawable;


   protected DefaultComparableDrawable(Drawable var1) {
      this.setWrappedDrawable(var1);
   }

   public static DefaultComparableDrawable create(Drawable var0) {
      return new DefaultComparableDrawable(var0);
   }

   public static boolean isDefaultComparableDrawable(ComparableDrawable var0) {
      return var0 instanceof DefaultComparableDrawable;
   }

   public static boolean isEquivalentToWithExperiment(@Nullable ComparableDrawable var0, @Nullable ComparableDrawable var1) {
      boolean var2 = false;
      if(var0 == null) {
         if(var1 == null) {
            var2 = true;
         ...
         return var1 == null?false:(ComponentsConfiguration.areDefaultComparableDrawablesAlwaysEquivalent && isDefaultComparableDrawable(var0) && isDefaultComparableDrawable(var1)?true:var0.isEquivalentTo(var1));
      }
   }
   ...
   public boolean isEquivalentTo(ComparableDrawable var1) {
      return this == var1?true:(!(var1 instanceof DefaultComparableDrawable)?false:this.mDrawable.equals(((DefaultComparableDrawable)var1).mDrawable));
   }
