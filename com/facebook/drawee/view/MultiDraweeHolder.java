...
public class MultiDraweeHolder<DH extends Object & DraweeHierarchy> {
   ...
   public void add(int var1, DraweeHolder<DH> var2) {
      ...
      Preconditions.checkElementIndex(var1, this.mHolders.size() + 1);
   ...
   public void onDetach() {
      if(this.mIsAttached) {
         ...
         for(this.mIsAttached = false; var1 < this.mHolders.size(); ++var1) {
            ((DraweeHolder)this.mHolders.get(var1)).onDetach();
         }
