...
public class RoundedBitmapDrawable extends BitmapDrawable implements Rounded, TransformAwareDrawable {
   ...
   private void updatePath() {
      if(this.mIsPathDirty) {
         ...
         if(this.mIsCircle) {
            float var1 = Math.min(this.mRootBounds.width(), this.mRootBounds.height()) / 2.0F;
            this.mBorderPath.addCircle(this.mRootBounds.centerX(), this.mRootBounds.centerY(), var1, Direction.CW);
         } else {
            for(int var2 = 0; var2 < this.mBorderRadii.length; ++var2) {
               this.mBorderRadii[var2] = this.mCornerRadii[var2] + this.mPadding - this.mBorderWidth / 2.0F;
            }
   ...
   public void setRadii(float[] var1) {
      if(var1 == null) {
         ...
         Preconditions.checkArgument(var4, "radii should have exactly 8 values");
         System.arraycopy(var1, 0, this.mCornerRadii, 0, 8);
         this.mRadiiNonZero = false;

         for(int var2 = 0; var2 < 8; ++var2) {
            var4 = this.mRadiiNonZero;
            boolean var3;
            if(var1[var2] > 0.0F) {
               var3 = true;
            } else {
