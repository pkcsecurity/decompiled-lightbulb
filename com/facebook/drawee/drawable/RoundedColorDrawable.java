...
public class RoundedColorDrawable extends Drawable implements Rounded {
   ...
   private void updatePath() {
      ...
      float var1;
      if(this.mIsCircle) {
         var1 = Math.min(this.mTempRect.width(), this.mTempRect.height()) / 2.0F;
         this.mBorderPath.addCircle(this.mTempRect.centerX(), this.mTempRect.centerY(), var1, Direction.CW);
      } else {
         for(int var2 = 0; var2 < this.mBorderRadii.length; ++var2) {
            this.mBorderRadii[var2] = this.mRadii[var2] + this.mPadding - this.mBorderWidth / 2.0F;
         }
      ...
      if(this.mIsCircle) {
         var1 = Math.min(this.mTempRect.width(), this.mTempRect.height()) / 2.0F;
         this.mPath.addCircle(this.mTempRect.centerX(), this.mTempRect.centerY(), var1, Direction.CW);
      } else {
