...
@NotThreadSafe
class OOMSoftReferenceBucket<V extends Object> extends Bucket<V> {
   ...
   void addToFreeList(V var1) {
      OOMSoftReference var3 = (OOMSoftReference)this.mSpareReferences.poll();
      OOMSoftReference var2 = var3;
      if(var3 == null) {
