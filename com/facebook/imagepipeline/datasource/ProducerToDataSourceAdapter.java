...
@ThreadSafe
public class ProducerToDataSourceAdapter<T extends Object> extends AbstractProducerToDataSourceAdapter<T> {

   private ProducerToDataSourceAdapter(Producer<T> var1, SettableProducerContext var2, RequestListener var3) {
      super(var1, var2, var3);
   }

   public static <T extends Object> DataSource<T> create(Producer<T> var0, SettableProducerContext var1, RequestListener var2) {
