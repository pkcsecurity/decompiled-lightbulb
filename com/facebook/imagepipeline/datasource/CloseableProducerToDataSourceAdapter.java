...
@ThreadSafe
public class CloseableProducerToDataSourceAdapter<T extends Object> extends AbstractProducerToDataSourceAdapter<CloseableReference<T>> {
   ...
   public static <T extends Object> DataSource<CloseableReference<T>> create(Producer<CloseableReference<T>> var0, SettableProducerContext var1, RequestListener var2) {
