...
@ThreadSafe
public final class SettableDataSource<T extends Object> extends AbstractDataSource<CloseableReference<T>> {

   public static <V extends Object> SettableDataSource<V> create() {
