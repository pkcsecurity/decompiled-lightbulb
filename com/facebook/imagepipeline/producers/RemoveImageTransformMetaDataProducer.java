...
public class RemoveImageTransformMetaDataProducer implements Producer<CloseableReference<PooledByteBuffer>> {
   ...
   public void produceResults(Consumer<CloseableReference<PooledByteBuffer>> var1, ProducerContext var2) {
      this.mInputProducer.produceResults(new RemoveImageTransformMetaDataProducer.RemoveImageTransformMetaDataConsumer(var1, null), var2);
   }

   class RemoveImageTransformMetaDataConsumer extends DelegatingConsumer<EncodedImage, CloseableReference<PooledByteBuffer>> {

      private RemoveImageTransformMetaDataConsumer(Consumer var2) {
         super(var2);
      }
