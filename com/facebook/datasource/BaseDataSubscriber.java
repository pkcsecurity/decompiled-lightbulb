...
public abstract class BaseDataSubscriber<T extends Object> implements DataSubscriber<T> {
   ...
   public abstract void onFailureImpl(DataSource<T> var1);
   ...
   public abstract void onNewResultImpl(DataSource<T> var1);
