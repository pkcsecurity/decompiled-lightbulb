...
public class ConstrainedExecutorService extends AbstractExecutorService {
   ...
   public ConstrainedExecutorService(String var1, int var2, Executor var3, BlockingQueue<Runnable> var4) {
      if(var2 <= 0) {
         ...
         this.mTaskRunner = new ConstrainedExecutorService.Worker(null);
   ...
   private void startWorkerIfNeeded() {
      for(int var1 = this.mPendingWorkers.get(); var1 < this.mMaxConcurrency; var1 = this.mPendingWorkers.get()) {
         ...
         if(this.mPendingWorkers.compareAndSet(var1, var2)) {
            FLog.v(TAG, "%s: starting worker %d of %d", this.mName, Integer.valueOf(var2), Integer.valueOf(this.mMaxConcurrency));
   ...
   public void execute(Runnable var1) {
      if(var1 == null) {
         ...
         var4.append(" queue is full, size=");
         var4.append(this.mWorkQueue.size());
         throw new RejectedExecutionException(var4.toString());
      } else {
         int var2 = this.mWorkQueue.size();
         int var3 = this.mMaxQueueSize.get();
         if(var2 > var3 && this.mMaxQueueSize.compareAndSet(var3, var2)) {
            FLog.v(TAG, "%s: max pending work in queue = %d", (Object)this.mName, (Object)Integer.valueOf(var2));
         }
