...
public class HandlerExecutorServiceImpl extends AbstractExecutorService implements HandlerExecutorService {
   ...
   protected <T extends Object> ScheduledFutureImpl<T> newTaskFor(Runnable var1, T var2) {
      return new ScheduledFutureImpl(this.mHandler, var1, var2);
   }

   protected <T extends Object> ScheduledFutureImpl<T> newTaskFor(Callable<T> var1) {
   ...
   public <V extends Object> ScheduledFuture<V> schedule(Callable<V> var1, long var2, TimeUnit var4) {
   ...
   public <T extends Object> ScheduledFuture<T> submit(Runnable var1, @Nullable T var2) {
      if(var1 == null) {
   ...
   public <T extends Object> ScheduledFuture<T> submit(Callable<T> var1) {
      if(var1 == null) {
         throw new NullPointerException();
      } else {
