   ...
   public static void register(ActivityListener var0, Context var1) {
      ...
      if(!(var1 instanceof ListenableActivity)) {
         ...
         if(var1 instanceof ContextWrapper) {
            var2 = ((ContextWrapper)var1).getBaseContext();
         }
      }

      if(var2 instanceof ListenableActivity) {
         ((ListenableActivity)var2).addActivityListener(new ActivityListenerManager.Listener(var0));
      }
