...
public class HorizontalBarChart extends BarChart {
   ...
   public void calculateOffsets() {
      ...
      float var6 = this.mOffsetsBuffer.left + 0.0F;
      float var2 = this.mOffsetsBuffer.top + 0.0F;
      float var5 = this.mOffsetsBuffer.right + 0.0F;
      float var1 = this.mOffsetsBuffer.bottom + 0.0F;
      float var3 = var2;
      if(this.mAxisLeft.needsOffset()) {
         var3 = var2 + this.mAxisLeft.getRequiredHeightSpace(this.mAxisRendererLeft.getPaintAxisLabels());
      }

      float var4 = var1;
      if(this.mAxisRight.needsOffset()) {
         var4 = var1 + this.mAxisRight.getRequiredHeightSpace(this.mAxisRendererRight.getPaintAxisLabels());
      }
      ...
      var3 += this.getExtraTopOffset();
      var2 += this.getExtraRightOffset();
      var4 += this.getExtraBottomOffset();
      var1 += this.getExtraLeftOffset();
      var5 = Utils.convertDpToPixel(this.mMinOffset);
      this.mViewPortHandler.restrainViewPort(Math.max(var5, var1), Math.max(var5, var3), Math.max(var5, var2), Math.max(var5, var4));
      if(this.mLogEnabled) {
   ...
   public void getBarBounds(BarEntry var1, RectF var2) {
      IBarDataSet var7 = (IBarDataSet)((BarData)this.mData).getDataSetForEntry(var1);
      if(var7 == null) {
         ...
         var2.set(var4, var5 - var6, var3, var5 + var6);
         this.getTransformer(var7.getAxisDependency()).rectValueToPixel(var2);
      }
   }
