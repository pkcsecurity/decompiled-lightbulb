...
public class CombinedChart extends BarLineChartBase<CombinedData> implements CombinedDataProvider {
   ...
   protected void drawMarkers(Canvas var1) {
      if(this.mMarker != null && this.isDrawMarkersEnabled()) {
         if(this.valuesToHighlight()) {
            for(int var2 = 0; var2 < this.mIndicesToHighlight.length; ++var2) {
               Highlight var3 = this.mIndicesToHighlight[var2];
               IBarLineScatterCandleBubbleDataSet var5 = ((CombinedData)this.mData).getDataSetByHighlight(var3);
               Entry var4 = ((CombinedData)this.mData).getEntryForHighlight(var3);
               if(var4 != null && (float)var5.getEntryIndex(var4) <= (float)var5.getEntryCount() * this.mAnimator.getPhaseX()) {
                  float[] var6 = this.getMarkerPosition(var3);
                  if(this.mViewPortHandler.isInBounds(var6[0], var6[1])) {
                     this.mMarker.refreshContent(var4, var3);
   ...
   public Highlight getHighlightByTouchPoint(float var1, float var2) {
      if(this.mData == null) {
         ...
         return var3 != null?(!this.isHighlightFullBarEnabled()?var3:new Highlight(var3.getX(), var3.getY(), var3.getXPx(), var3.getYPx(), var3.getDataSetIndex(), -1, var3.getAxis())):var3;
      }
   }
   ...
   public static enum DrawOrder {
      ...
      // $FF: synthetic field
      private static final CombinedChart.DrawOrder[] $VALUES = new CombinedChart.DrawOrder[]{BAR, BUBBLE, LINE, CANDLE, SCATTER};
      BAR("BAR", 0),
      BUBBLE("BUBBLE", 1),
      CANDLE("CANDLE", 3),
      LINE("LINE", 2),
      ...
      private DrawOrder(String var1, int var2) {}
   }
}
