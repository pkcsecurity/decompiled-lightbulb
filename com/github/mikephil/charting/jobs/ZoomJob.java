...
public class ZoomJob extends ViewPortJob {
   ...
   public void run() {
      Matrix var3 = this.mRunMatrixBuffer;
      this.mViewPortHandler.zoom(this.scaleX, this.scaleY, var3);
      this.mViewPortHandler.refresh(var3, this.view, false);
      float var1 = ((BarLineChartBase)this.view).getAxis(this.axisDependency).mAxisRange / this.mViewPortHandler.getScaleY();
      float var2 = ((BarLineChartBase)this.view).getXAxis().mAxisRange / this.mViewPortHandler.getScaleX();
      this.pts[0] = this.xValue - var2 / 2.0F;
      this.pts[1] = this.yValue + var1 / 2.0F;
      this.mTrans.pointValuesToPixel(this.pts);
      this.mViewPortHandler.translate(this.pts, var3);
      this.mViewPortHandler.refresh(var3, this.view, false);
