...
public class AnimatedZoomJob extends AnimatedViewPortJob implements AnimatorListener {
   ...
   public void onAnimationUpdate(ValueAnimator var1) {
      ...
      var2 = this.yAxis.mAxisRange / this.mViewPortHandler.getScaleY();
      var3 = this.xAxisRange / this.mViewPortHandler.getScaleX();
      this.pts[0] = this.zoomOriginX + (this.zoomCenterX - var3 / 2.0F - this.zoomOriginX) * this.phase;
      this.pts[1] = this.zoomOriginY + (this.zoomCenterY + var2 / 2.0F - this.zoomOriginY) * this.phase;
