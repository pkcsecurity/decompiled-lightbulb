...
public class PieDataSet extends DataSet<PieEntry> implements IPieDataSet {
   ...
   public PieDataSet(List<PieEntry> var1, String var2) {
      super(var1, var2);
   ...
   public DataSet<PieEntry> copy() {
      ...
      for(int var1 = 0; var1 < this.mValues.size(); ++var1) {
         var2.add(((PieEntry)this.mValues.get(var1)).copy());
      }

      PieDataSet var3 = new PieDataSet(var2, this.getLabel());
   ...
   public static enum ValuePosition {
      ...
      // $FF: synthetic field
      private static final PieDataSet.ValuePosition[] $VALUES = new PieDataSet.ValuePosition[]{INSIDE_SLICE, OUTSIDE_SLICE};
      INSIDE_SLICE("INSIDE_SLICE", 0),
      OUTSIDE_SLICE("OUTSIDE_SLICE", 1);


      private ValuePosition(String var1, int var2) {}
   }
}
