...
public class BarDataSet extends BarLineScatterCandleBubbleDataSet<BarEntry> implements IBarDataSet {
   ...
   public BarDataSet(List<BarEntry> var1, String var2) {
      super(var1, var2);
   ...
   private void calcEntryCountIncludingStacks(List<BarEntry> var1) {
      int var2 = 0;
   ...
   private void calcStackSize(List<BarEntry> var1) {
   ...
   public DataSet<BarEntry> copy() {
      ...
      for(int var1 = 0; var1 < this.mValues.size(); ++var1) {
         var2.add(((BarEntry)this.mValues.get(var1)).copy());
      }

      BarDataSet var3 = new BarDataSet(var2, this.getLabel());
