...
public class Entry extends BaseEntry implements Parcelable {
   ...
   public boolean equalTo(Entry var1) {
      return var1 == null?false:(var1.getData() != this.getData()?false:(Math.abs(var1.x - this.x) > Utils.FLOAT_EPSILON?false:Math.abs(var1.getY() - this.getY()) <= Utils.FLOAT_EPSILON));
   }
