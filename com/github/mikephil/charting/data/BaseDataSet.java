...
public abstract class BaseDataSet<T extends Entry> implements IDataSet<T> {
   ...
   public void addColor(int var1) {
      ...
      this.mColors.add(Integer.valueOf(var1));
   }
   ...
   public int getColor(int var1) {
      return ((Integer)this.mColors.get(var1 % this.mColors.size())).intValue();
   }
   ...
   public int getValueTextColor(int var1) {
      return ((Integer)this.mValueColors.get(var1 % this.mValueColors.size())).intValue();
   }
   ...
   public void setColors(List<Integer> var1) {
      this.mColors = var1;
   }
   ...
   public void setColors(int[] var1, Context var2) {
      ...
      for(int var3 = 0; var3 < var4; ++var3) {
         int var5 = var1[var3];
         this.mColors.add(Integer.valueOf(var2.getResources().getColor(var5)));
      }
   ...
   public void setValueTextColor(int var1) {
      ...
      this.mValueColors.add(Integer.valueOf(var1));
   }
