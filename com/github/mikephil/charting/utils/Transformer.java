...
public class Transformer {
   ...
   public void pathValuesToPixel(List<Path> var1) {
   ...
   public void prepareMatrixValuePx(float var1, float var2, float var3, float var4) {
      float var6 = this.mViewPortHandler.contentWidth() / var2;
      float var5 = this.mViewPortHandler.contentHeight() / var3;
      var2 = var6;
   ...
   public void rectValuesToPixel(List<RectF> var1) {
      Matrix var3 = this.getValueToPixelMatrix();

      for(int var2 = 0; var2 < var1.size(); ++var2) {
         var3.mapRect((RectF)var1.get(var2));
      }
