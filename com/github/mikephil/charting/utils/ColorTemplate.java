...
public class ColorTemplate {
   ...
   public static List<Integer> createColors(Resources var0, int[] var1) {
      ArrayList var4 = new ArrayList();
      int var3 = var1.length;

      for(int var2 = 0; var2 < var3; ++var2) {
         var4.add(Integer.valueOf(var0.getColor(var1[var2])));
      }

      return var4;
   }

   public static List<Integer> createColors(int[] var0) {
      ArrayList var3 = new ArrayList();
      int var2 = var0.length;

      for(int var1 = 0; var1 < var2; ++var1) {
         var3.add(Integer.valueOf(var0[var1]));
      }
