...
public class MarkerImage implements IMarker {
   ...
   public void draw(Canvas var1, float var2, float var3) {
      if(this.mDrawable != null) {
         MPPointF var8 = this.getOffsetForDrawingAtPoint(var2, var3);
         ...
         if(var5 == 0.0F) {
            var4 = var5;
            if(this.mDrawable != null) {
               var4 = (float)this.mDrawable.getIntrinsicWidth();
            }
         }
         ...
         this.mDrawable.setBounds(this.mDrawableBoundsCache.left, this.mDrawableBoundsCache.top, this.mDrawableBoundsCache.left + (int)var4, this.mDrawableBoundsCache.top + (int)var5);
         int var7 = var1.save();
         var1.translate(var2 + var8.x, var3 + var8.y);
   ...
   public MPPointF getOffsetForDrawingAtPoint(float var1, float var2) {
      MPPointF var6 = this.getOffset();
      this.mOffset2.x = var6.x;
      this.mOffset2.y = var6.y;
      ...
      if(var4 == 0.0F) {
         var3 = var4;
         if(this.mDrawable != null) {
            var3 = (float)this.mDrawable.getIntrinsicWidth();
         }
      }
      ...
      } else if(var7 != null && var1 + var3 + this.mOffset2.x > (float)var7.getWidth()) {
         this.mOffset2.x = (float)var7.getWidth() - var1 - var3;
      }
