...
public abstract class AxisBase extends ComponentBase {
   ...
   public void calculate(float var1, float var2) {
      ...
      this.mAxisMinimum = var4;
      this.mAxisMaximum = var3;
      this.mAxisRange = Math.abs(var3 - var4);
   }
   ...
   public String getLongestLabel() {
      ...
      String var3;
      for(int var1 = 0; var1 < this.mEntries.length; var2 = var3) {
         String var4 = this.getFormattedLabel(var1);
         var3 = var2;
         if(var4 != null) {
            var3 = var2;
