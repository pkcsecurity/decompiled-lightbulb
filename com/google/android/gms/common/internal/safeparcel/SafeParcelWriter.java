...
public class SafeParcelWriter {
   ...
   public static void writeDoubleList(Parcel var0, int var1, List<Double> var2, boolean var3) {
      ...
      if(var2 == null) {
         ...
         for(var1 = var4; var1 < var6; ++var1) {
            var0.writeDouble(((Double)var2.get(var1)).doubleValue());
         }
   ...
   public static void writeDoubleSparseArray(Parcel var0, int var1, SparseArray<Double> var2, boolean var3) {
      ...
      if(var2 == null) {
         ...
         for(var1 = var4; var1 < var6; ++var1) {
            var0.writeInt(var2.keyAt(var1));
            var0.writeDouble(((Double)var2.valueAt(var1)).doubleValue());
         }
   ...
   public static void writeFloatList(Parcel var0, int var1, List<Float> var2, boolean var3) {
      ...
      if(var2 == null) {
         ...
         for(var1 = var4; var1 < var6; ++var1) {
            var0.writeFloat(((Float)var2.get(var1)).floatValue());
         }
   ...
   public static void writeFloatSparseArray(Parcel var0, int var1, SparseArray<Float> var2, boolean var3) {
      ...
      if(var2 == null) {
         ...
         for(var1 = var4; var1 < var6; ++var1) {
            var0.writeInt(var2.keyAt(var1));
            var0.writeFloat(((Float)var2.valueAt(var1)).floatValue());
         }
   ...
   public static void writeLongList(Parcel var0, int var1, List<Long> var2, boolean var3) {
      ...
      if(var2 == null) {
         ...
         for(var1 = var4; var1 < var6; ++var1) {
            var0.writeLong(((Long)var2.get(var1)).longValue());
         }
   ...
   public static <T extends Object & Parcelable> void writeTypedArray(Parcel var0, int var1, T[] var2, int var3, boolean var4) {
      if(var2 == null) {
         if(var4) {
            zzb(var0, var1, 0);
         }
   ...
   public static <T extends Object & Parcelable> void writeTypedList(Parcel var0, int var1, List<T> var2, boolean var3) {
      if(var2 == null) {
         if(var3) {
            zzb(var0, var1, 0);
         }
   ...
   public static <T extends Object & Parcelable> void writeTypedSparseArray(Parcel var0, int var1, SparseArray<T> var2, boolean var3) {
      if(var2 == null) {
         if(var3) {
            zzb(var0, var1, 0);
         }
   ...
   private static <T extends Object & Parcelable> void zza(Parcel var0, T var1, int var2) {
