...
public class SafeParcelReader {
   ...
   public static ArrayList<Double> createDoubleList(Parcel var0, int var1) {
      ...
      if(var2 == 0) {
         ...
         for(var1 = 0; var1 < var4; ++var1) {
            var5.add(Double.valueOf(var0.readDouble()));
         }
   ...
   public static SparseArray<Double> createDoubleSparseArray(Parcel var0, int var1) {
      ...
      if(var2 == 0) {
         ...
         for(var1 = 0; var1 < var4; ++var1) {
            var5.append(var0.readInt(), Double.valueOf(var0.readDouble()));
         }
   ...
   public static ArrayList<Float> createFloatList(Parcel var0, int var1) {
      ...
      if(var2 == 0) {
         ...
         for(var1 = 0; var1 < var4; ++var1) {
            var5.add(Float.valueOf(var0.readFloat()));
         }
   ...
   public static SparseArray<Float> createFloatSparseArray(Parcel var0, int var1) {
      ...
      if(var2 == 0) {
         ...
         for(var1 = 0; var1 < var4; ++var1) {
            var5.append(var0.readInt(), Float.valueOf(var0.readFloat()));
         }
   ...
   public static ArrayList<Long> createLongList(Parcel var0, int var1) {
      ...
      if(var2 == 0) {
         ...
         for(var1 = 0; var1 < var4; ++var1) {
            var5.add(Long.valueOf(var0.readLong()));
         }
      ...
      if(var2 == 0) {
         ...
         for(var1 = 0; var1 < var4; ++var1) {
            ...
            if(var6 != 0) {
               ...
               var9.appendFrom(var0, var7, var6);
               var8.append(var5, var9);
               var0.setDataPosition(var7 + var6);
            } else {
               var8.append(var5, (Object)null);
            }
         }
   ...
   public static <T extends Object & Parcelable> T createParcelable(Parcel var0, int var1, Creator<T> var2) {
      var1 = readSize(var0, var1);
      int var3 = var0.dataPosition();
      if(var1 == 0) {
         return null;
   ...
   public static SparseIntArray createSparseIntArray(Parcel var0, int var1) {
      ...
      if(var2 == 0) {
         ...
         for(var1 = 0; var1 < var4; ++var1) {
            var5.append(var0.readInt(), var0.readInt());
         }
   ...
   public static SparseLongArray createSparseLongArray(Parcel var0, int var1) {
      ...
      if(var2 == 0) {
         ...
         SparseLongArray var5 = new SparseLongArray();
         int var4 = var0.readInt();

         for(var1 = 0; var1 < var4; ++var1) {
            var5.append(var0.readInt(), var0.readLong());
         }
   ...
   public static SparseArray<String> createStringSparseArray(Parcel var0, int var1) {
      ...
      if(var2 == 0) {
         ...
         for(var1 = 0; var1 < var4; ++var1) {
            var5.append(var0.readInt(), var0.readString());
         }
   ...
   public static <T extends Object> T[] createTypedArray(Parcel var0, int var1, Creator<T> var2) {
      var1 = readSize(var0, var1);
      int var3 = var0.dataPosition();
      if(var1 == 0) {
         return null;
   ...
   public static <T extends Object> ArrayList<T> createTypedList(Parcel var0, int var1, Creator<T> var2) {
      var1 = readSize(var0, var1);
      int var3 = var0.dataPosition();
      if(var1 == 0) {
         return null;
   ...
   public static <T extends Object> SparseArray<T> createTypedSparseArray(Parcel var0, int var1, Creator<T> var2) {
      ...
      if(var3 == 0) {
         ...
         for(var1 = 0; var1 < var5; ++var1) {
            ...
            Object var7;
            if(var0.readInt() != 0) {
               var7 = var2.createFromParcel(var0);
            } else {
               var7 = null;
            }

            var8.append(var6, var7);
         }
   ...
   public static int validateObjectHeader(Parcel var0) {
      int var2 = readHeader(var0);
      int var3 = readSize(var0, var2);
      int var1 = var0.dataPosition();
      if(getFieldId(var2) != 20293) {
         String var5 = String.valueOf(Integer.toHexString(var2));
         if(var5.length() != 0) {
