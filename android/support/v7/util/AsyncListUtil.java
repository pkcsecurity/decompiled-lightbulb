...
public class AsyncListUtil<T extends Object> {
   ...
   public AsyncListUtil(@NonNull Class<T> var1, int var2, @NonNull AsyncListUtil.DataCallback<T> var3, @NonNull AsyncListUtil.ViewCallback var4) {
   ...
   public abstract static class ViewCallback {
      ...
      @UiThread
      public void extendRangeInto(@NonNull int[] var1, @NonNull int[] var2, int var3) {
   ...
   public abstract static class DataCallback<T extends Object> {
      ...
      @WorkerThread
      public void recycleData(@NonNull T[] var1, int var2) {}
