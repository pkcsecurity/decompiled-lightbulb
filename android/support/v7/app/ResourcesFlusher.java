...
class ResourcesFlusher {
   ...
   static void flush(@NonNull Resources var0) {
   ...
   @RequiresApi(21)
   private static void flushLollipops(@NonNull Resources var0) {
   ...
   @RequiresApi(23)
   private static void flushMarshmallows(@NonNull Resources var0) {
      if(!sDrawableCacheFieldFetched) {
         try {
            sDrawableCacheField = Resources.class.getDeclaredField("mDrawableCache");
            sDrawableCacheField.setAccessible(true);
   ...
   @RequiresApi(24)
   private static void flushNougats(@NonNull Resources var0) {
   ...
   @RequiresApi(16)
   private static void flushThemedResourcesCache(@NonNull Object var0) {
