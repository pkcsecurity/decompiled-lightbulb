...
class ViewBoundsCheck {
   ...
   static class BoundFlags {
      ...
      boolean boundsMatch() {
         return (this.mBoundFlags & 7) != 0 && (this.mBoundFlags & this.compare(this.mChildStart, this.mRvStart) << 0) == 0?false:((this.mBoundFlags & 112) != 0 && (this.mBoundFlags & this.compare(this.mChildStart, this.mRvEnd) << 4) == 0?false:((this.mBoundFlags & 1792) != 0 && (this.mBoundFlags & this.compare(this.mChildEnd, this.mRvStart) << 8) == 0?false:(this.mBoundFlags & 28672) == 0 || (this.mBoundFlags & this.compare(this.mChildEnd, this.mRvEnd) << 12) != 0));
      }

      int compare(int var1, int var2) {
         return var1 > var2?1:(var1 == var2?2:4);
      }
      ...
      void setFlags(int var1, int var2) {
         this.mBoundFlags = var1 & var2 | this.mBoundFlags & ~var2;
      }
   }
