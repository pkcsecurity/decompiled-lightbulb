...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.ScrollVectorProvider, ItemTouchHelper.ViewDropHandler {
   ...
   private boolean updateAnchorFromPendingData(RecyclerView.State var1, LinearLayoutManager.AnchorInfo var2) {
      ...
      if(!var4) {
         if(this.mPendingScrollPosition == -1) {
            return false;
         } else if(this.mPendingScrollPosition >= 0 && this.mPendingScrollPosition < var1.getItemCount()) {
   ...
   public void collectAdjacentPrefetchPositions(int var1, int var2, RecyclerView.State var3, RecyclerView.LayoutPrefetchRegistry var4) {
   ...
   public void collectInitialPrefetchPositions(int var1, RecyclerView.LayoutPrefetchRegistry var2) {
      LinearLayoutManager.SavedState var8 = this.mPendingSavedState;
      byte var4 = -1;
      int var3;
      boolean var7;
      if(var8 != null && this.mPendingSavedState.hasValidAnchor()) {
         var7 = this.mPendingSavedState.mAnchorLayoutFromEnd;
         var3 = this.mPendingSavedState.mAnchorPosition;
      } else {
         this.resolveShouldLayoutReverse();
         var7 = this.mShouldReverseLayout;
         if(this.mPendingScrollPosition == -1) {
            if(var7) {
               var3 = var1 - 1;
            } else {
   ...
   void collectPrefetchPositionsForLayoutState(RecyclerView.State var1, LinearLayoutManager.LayoutState var2, RecyclerView.LayoutPrefetchRegistry var3) {
   ...
   View findReferenceChild(RecyclerView.Recycler var1, RecyclerView.State var2, int var3, int var4, int var5) {
      ...
      View var11;
      View var13;
      for(var13 = null; var3 != var4; var13 = var11) {
      ...
      if(var13 == null) {
         ...
         if(this.mOrientation == 1) {
            if(this.isLayoutRTL()) {
               ...
               var8 = var5 - this.mOrientationHelper.getDecoratedMeasurementInOther(var13);
            } else {
               var8 = this.getPaddingLeft();
               var5 = this.mOrientationHelper.getDecoratedMeasurementInOther(var13) + var8;
            }
         ...
         this.layoutDecoratedWithMargins(var13, var8, var5, var6, var7);
   ...
   public View onFocusSearchFailed(View var1, int var2, RecyclerView.Recycler var3, RecyclerView.State var4) {
      ...
      if(this.getChildCount() == 0) {
         ...
         if(var2 == Integer.MIN_VALUE) {
            ...
            return var5.hasFocusable()?(var1 == null?null:var5):var1;
         }
      }
   }
   ...
   public void onLayoutChildren(RecyclerView.Recycler var1, RecyclerView.State var2) {
      ...
      if((var8 != null || this.mPendingScrollPosition != -1) && var2.getItemCount() == 0) {
         ...
         int var4 = this.getExtraLayoutSpace(var2);
         int var3;
         ...
         int var7 = var3 + this.mOrientationHelper.getEndPadding();
         var3 = var6;
         var4 = var7;
         if(var2.isPreLayout()) {
            var3 = var6;
            ...
            if(this.mPendingScrollPosition != -1) {
               ...
               if(this.mPendingScrollPositionOffset != Integer.MIN_VALUE) {
                  var10 = this.findViewByPosition(this.mPendingScrollPosition);
                  var3 = var6;
                  var4 = var7;
                  if(var10 != null) {
                     if(this.mShouldReverseLayout) {
         ...
         int var9;
         LinearLayoutManager.LayoutState var11;
         if(this.mAnchorInfo.mLayoutFromEnd) {
            ...
            if(this.mLayoutState.mAvailable > 0) {
               ...
               this.updateLayoutStateToFillStart(var7, var9);
               this.mLayoutState.mExtra = var3;
               this.fill(var1, this.mLayoutState, var2, false);
            ...
            if(this.mLayoutState.mAvailable > 0) {
               var3 = this.mLayoutState.mAvailable;
               this.updateLayoutStateToFillEnd(var7, var9);
               this.mLayoutState.mExtra = var3;
               this.fill(var1, this.mLayoutState, var2, false);
         ...
         if(this.getChildCount() > 0) {
            if(this.mShouldReverseLayout ^ this.mStackFromEnd) {
               ...
               var9 = var4 + var6;
               var4 = this.fixLayoutStartGap(var9, var1, var2, false);
               var9 += var4;
               var6 = var3 + var6 + var4;
            } else {
         ...
         this.layoutForPredictiveAnimations(var1, var2, var9, var6);
         if(!var2.isPreLayout()) {
   ...
   public void prepareForDrop(@NonNull View var1, @NonNull View var2, int var3, int var4) {
         ...
         if(var3 >= 0) {
            ...
            if(this.mLayoutFromEnd) {
               ...
               if(var2 > 0) {
                  ...
                  var3 = this.mOrientationHelper.getEndAfterPadding() - Math.min(0, var6 - var3 - var7) - (var4 + var5);
                  if(var3 < 0) {
                     this.mCoordinate -= Math.min(var2, -var3);
                  }
               }
