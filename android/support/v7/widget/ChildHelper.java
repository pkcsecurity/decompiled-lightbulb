...
class ChildHelper {
   ...
   int indexOfChild(View var1) {
      int var2 = this.mCallback.indexOfChild(var1);
      return var2 == -1?-1:(this.mBucket.get(var2)?-1:var2 - this.mBucket.countOnesBefore(var2));
   }
   ...
   static class Bucket {
      ...
      int countOnesBefore(int var1) {
         return this.mNext == null?(var1 >= 64?Long.bitCount(this.mData):Long.bitCount(this.mData & (1L << var1) - 1L)):(var1 < 64?Long.bitCount(this.mData & (1L << var1) - 1L):this.mNext.countOnesBefore(var1 - 64) + Long.bitCount(this.mData));
      }
      ...
      boolean remove(int var1) {
         if(var1 >= 64) {
            ...
            this.mData &= ~var2;
            --var2;
            this.mData = this.mData & var2 | Long.rotateRight(this.mData & ~var2, 1);
            if(this.mNext != null) {
               if(this.mNext.get(0)) {
                  this.set(63);
               }
