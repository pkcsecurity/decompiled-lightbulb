...
class ViewInfoStore {
   ...
   private RecyclerView.ItemHolderInfo popFromLayoutStep(RecyclerView.ViewHolder var1, int var2) {
      ...
      if(var3 < 0) {
         ...
         if(var4 != null && (var4.flags & var2) != 0) {
            var4.flags &= ~var2;
            RecyclerView.ItemHolderInfo var5;
            if(var2 == 4) {
               var5 = var4.preInfo;
            } else {
               if(var2 != 8) {
   ...
   void process(ViewInfoStore.ProcessCallback var1) {
      for(int var2 = this.mLayoutHolderMap.size() - 1; var2 >= 0; --var2) {
         ...
         if((var5.flags & 3) == 3) {
            ...
            var1.processDisappeared(var4, var5.preInfo, (RecyclerView.ItemHolderInfo)null);
   ...
   interface ProcessCallback {
      ...
      void processDisappeared(RecyclerView.ViewHolder var1, @NonNull RecyclerView.ItemHolderInfo var2, @Nullable RecyclerView.ItemHolderInfo var3);
