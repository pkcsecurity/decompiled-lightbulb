...
public class RecyclerViewAccessibilityDelegate extends AccessibilityDelegateCompat {
   ...
   public RecyclerViewAccessibilityDelegate(@NonNull RecyclerView var1) {
   ...
   public static class ItemDelegate extends AccessibilityDelegateCompat {
      ...
      public ItemDelegate(@NonNull RecyclerViewAccessibilityDelegate var1) {
      ...
      public boolean performAccessibilityAction(View var1, int var2, Bundle var3) {
         return super.performAccessibilityAction(var1, var2, var3)?true:(!this.mRecyclerViewDelegate.shouldIgnore() && this.mRecyclerViewDelegate.mRecyclerView.getLayoutManager() != null?this.mRecyclerViewDelegate.mRecyclerView.getLayoutManager().performAccessibilityActionForItem(var1, var2, var3):false);
      }
   }
}
