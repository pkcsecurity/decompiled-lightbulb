...
public final class PermissionChecker {
   ...
   public static int checkCallingPermission(@NonNull Context var0, @NonNull String var1, @Nullable String var2) {
      return Binder.getCallingPid() == Process.myPid()?-1:checkPermission(var0, var1, Binder.getCallingPid(), Binder.getCallingUid(), var2);
   }

   public static int checkPermission(@NonNull Context var0, @NonNull String var1, int var2, int var3, @Nullable String var4) {
