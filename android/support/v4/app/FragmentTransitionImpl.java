...
public abstract class FragmentTransitionImpl {
   ...
   protected static void bfsAddViewChildren(List<View> var0, View var1) {
      int var4 = var0.size();
   ...
   static String findKeyForValue(Map<String, String> var0, String var1) {
   ...
   void captureTransitioningViews(ArrayList<View> var1, View var2) {
   ...
   void findNamedViews(Map<String, View> var1, View var2) {
      if(var2.getVisibility() == 0) {
   ...
   ArrayList<String> prepareSetNameOverridesReordered(ArrayList<View> var1) {
   ...
   void scheduleNameReset(ViewGroup var1, final ArrayList<View> var2, final Map<String, String> var3) {
   ...
   void setNameOverridesOrdered(View var1, final ArrayList<View> var2, final Map<String, String> var3) {
      OneShotPreDrawListener.add(var1, new Runnable() {
         public void run() {
            int var2x = var2.size();
   ...
   void setNameOverridesReordered(View var1, final ArrayList<View> var2, final ArrayList<View> var3, final ArrayList<String> var4, Map<String, String> var5) {
