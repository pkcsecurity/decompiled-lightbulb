...
class DocumentsContractApi19 {
   ...
   public static boolean canRead(Context var0, Uri var1) {
      return var0.checkCallingOrSelfUriPermission(var1, 1) != 0?false:!TextUtils.isEmpty(getRawType(var0, var1));
   }
   ...
   public static boolean canWrite(Context var0, Uri var1) {
      if(var0.checkCallingOrSelfUriPermission(var1, 2) != 0) {
         ...
         return TextUtils.isEmpty(var3)?false:((var2 & 4) != 0?true:("vnd.android.document/directory".equals(var3) && (var2 & 8) != 0?true:!TextUtils.isEmpty(var3) && (var2 & 2) != 0));
      }
   }

   private static void closeQuietly(@Nullable AutoCloseable var0) {
      if(var0 != null) {
         try {
            var0.close();
   ...
   @Nullable
   private static String queryForString(Context param0, Uri param1, String param2, @Nullable String param3) {
      // $FF: Couldn't be decompiled
   }
}
