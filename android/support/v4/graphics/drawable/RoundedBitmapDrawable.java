...
public abstract class RoundedBitmapDrawable extends Drawable {
   ...
   public void draw(@NonNull Canvas var1) {
      ...
      if(var2 != null) {
         ...
         if(this.mPaint.getShader() == null) {
            var1.drawBitmap(var2, (Rect)null, this.mDstRect, this.mPaint);
         } else {
            var1.drawRoundRect(this.mDstRectF, this.mCornerRadius, this.mCornerRadius, this.mPaint);
         }
      }
   }
   ...
   public void setTargetDensity(@NonNull Canvas var1) {
      this.setTargetDensity(var1.getDensity());
   }

   public void setTargetDensity(@NonNull DisplayMetrics var1) {
