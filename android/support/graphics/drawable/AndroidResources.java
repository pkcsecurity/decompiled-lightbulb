...
class AndroidResources {
   ...
   static final int[] STYLEABLE_ANIMATED_VECTOR_DRAWABLE = new int[]{16843161};
   static final int STYLEABLE_ANIMATED_VECTOR_DRAWABLE_DRAWABLE = 0;
   static final int[] STYLEABLE_ANIMATED_VECTOR_DRAWABLE_TARGET = new int[]{16842755, 16843213};
   @StyleableRes
   ...
   public static final int[] STYLEABLE_ANIMATOR = new int[]{16843073, 16843160, 16843198, 16843199, 16843200, 16843486, 16843487, 16843488};
   ...
   static final int[] STYLEABLE_VECTOR_DRAWABLE_CLIP_PATH = new int[]{16842755, 16843781};
   ...
   static final int[] STYLEABLE_VECTOR_DRAWABLE_GROUP = new int[]{16842755, 16843189, 16843190, 16843556, 16843557, 16843558, 16843866, 16843867};
   ...
   static final int[] STYLEABLE_VECTOR_DRAWABLE_PATH = new int[]{16842755, 16843780, 16843781, 16843782, 16843783, 16843784, 16843785, 16843786, 16843787, 16843788, 16843789, 16843979, 16843980, 16844062};
   ...
   static final int[] STYLEABLE_VECTOR_DRAWABLE_TYPE_ARRAY = new int[]{16842755, 16843041, 16843093, 16843097, 16843551, 16843754, 16843771, 16843778, 16843779};
