...
public class Slide extends Visibility {
   ...
   private static final Slide.CalculateSlide sCalculateBottom = new Slide.CalculateSlideVertical(null) {
      public float getGoneY(ViewGroup var1, View var2) {
         return var2.getTranslationY() + (float)var1.getHeight();
      }
   };
   private static final Slide.CalculateSlide sCalculateEnd = new Slide.CalculateSlideHorizontal(null) {
   ...
   private static final Slide.CalculateSlide sCalculateLeft = new Slide.CalculateSlideHorizontal(null) {
      public float getGoneX(ViewGroup var1, View var2) {
         return var2.getTranslationX() - (float)var1.getWidth();
      }
   };
   private static final Slide.CalculateSlide sCalculateRight = new Slide.CalculateSlideHorizontal(null) {
      public float getGoneX(ViewGroup var1, View var2) {
         return var2.getTranslationX() + (float)var1.getWidth();
      }
   };
   private static final Slide.CalculateSlide sCalculateStart = new Slide.CalculateSlideHorizontal(null) {
      public float getGoneX(ViewGroup var1, View var2) {
         int var4 = ViewCompat.getLayoutDirection(var1);
         boolean var3 = true;
         if(var4 != 1) {
   ...
   private static final Slide.CalculateSlide sCalculateTop = new Slide.CalculateSlideVertical(null) {
      public float getGoneY(ViewGroup var1, View var2) {
         return var2.getTranslationY() - (float)var1.getHeight();
      }
   };
   ...
   abstract static class CalculateSlideVertical implements Slide.CalculateSlide {
   ...
   abstract static class CalculateSlideHorizontal implements Slide.CalculateSlide {
