...
class ViewUtilsBase {
   ...
   public float getTransitionAlpha(@NonNull View var1) {
      ...
      return var2 != null?var1.getAlpha() / var2.floatValue():var1.getAlpha();
   }

   public void saveNonTransitionAlpha(@NonNull View var1) {
      if(var1.getTag(R.id.save_non_transition_alpha) == null) {
         var1.setTag(R.id.save_non_transition_alpha, Float.valueOf(var1.getAlpha()));
      }
   ...
   public void setTransitionAlpha(@NonNull View var1, float var2) {
      ...
      if(var3 != null) {
         var1.setAlpha(var3.floatValue() * var2);
      } else {
         var1.setAlpha(var2);
      }
   }
