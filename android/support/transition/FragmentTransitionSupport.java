...
public class FragmentTransitionSupport extends FragmentTransitionImpl {
   ...
   public void scheduleRemoveTargets(Object var1, final Object var2, final ArrayList<View> var3, final Object var4, final ArrayList<View> var5, final Object var6, final ArrayList<View> var7) {
      ((Transition)var1).addListener(new Transition.TransitionListener() {
         ...
         public void onTransitionStart(@NonNull Transition var1) {
            if(var2 != null) {
               FragmentTransitionSupport.this.replaceTargets(var2, var3, (ArrayList)null);
            }

            if(var4 != null) {
               FragmentTransitionSupport.this.replaceTargets(var4, var5, (ArrayList)null);
            }

            if(var6 != null) {
               FragmentTransitionSupport.this.replaceTargets(var6, var7, (ArrayList)null);
            }
